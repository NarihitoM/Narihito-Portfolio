  ...
  return createPortal(
    <div ref={overlayRef} className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={handleClose}>
      ...
      <div
        ref={panelRef}
        data-lenis-prevent
        className="relative flex flex-col gap-6 w-full max-w-[400px] max-h-[85dvh] overflow-y-auto overscroll-contain rounded-[8px] border border-border-glow bg-bg-alt p-6 md:p-8"
