    ...
    <div className="flex min-h-screen flex-col px-5 py-12 md:px-10 md:py-20 lg:px-[120px]">
      ...
      <div className="mt-10 flex max-w-[720px] flex-col gap-8">
        <div className="flex flex-col gap-3">
          <h1 className="font-display fs-32 md:text-[44px] font-semibold text-text-primary">
            Privacy Policy
          </h1>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display fs-18 font-semibold text-text-primary">Contact form</h2>
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display fs-18 font-semibold text-text-primary">Chatbot</h2>
          <p className="font-body fs-15 leading-[1.7] text-text-secondary">
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display fs-18 font-semibold text-text-primary">Local storage</h2>
          <p className="font-body fs-15 leading-[1.7] text-text-secondary">
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display fs-18 font-semibold text-text-primary">Tracking</h2>
          <p className="font-body fs-15 leading-[1.7] text-text-secondary">
        ...
        <section className="flex flex-col gap-2">
          <h2 className="font-display fs-18 font-semibold text-text-primary">Contact</h2>
          <p className="font-body fs-15 leading-[1.7] text-text-secondary">
